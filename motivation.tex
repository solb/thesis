...
We use a single-machine experiment to evaluate the invocation overhead of
isolation: We use 14 \emph{worker} CPU cores to run microservices. Another
...
already resident, the tail latency of the serverless platform will be
determined by requests whose microservices must be loaded
...
interval up to two orders of magnitude faster than Linux's default \ms{4} time
quantum.
