...
runs a \emph{dispatch} process that initiates microservice execution on the workers.
...
\caption{Design of the language-based isolation approach.  The dispatch process forwards
...
by the two methods. For latency, we measure the time between when the dispatch
