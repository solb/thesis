...
\begin{itemize}
\item Programming with wires and switches and lights
\item Definition of a processor
\item Peripherals and the latency gap
\item Punchcards and printouts and batch processing
\item Definition of a process
\item Timesharing and context switching
\item Stored-program computers and operating systems
\item Cooperative multitasking and reliability
\item Definition of an interrupt
\item Timer interrupts and preemptive multitasking
\item Multiprocessing and parallelism
\item Multithreading and concurrency
\item Slowdown of Moore's Law and the narrowing of the latency gap
\item Definition of a function
\item Unlike threads, function calls are synchronous
\item Propose preemptible functions
\end{itemize}
