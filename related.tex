...
Although some cooperative systems refine their approach to have developed mechanisms
to tolerate either blocking-call code sections \solb{cite RT} or excessively-tight
loops \solb{cite Lilt}, we're not aware of any that are capable of handling both
cases.
...
systems developed (here, ``\textit{RT}'') by Mollison and
...
\dga{It still isn't.  Maybe foreshadow that we'll soon blow a hole in them.}
