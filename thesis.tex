...
See Figure~\ref{fig:reinit} and Figure~\ref{fig:reinit_tls}.
...
\begin{figure}
\includegraphics[width=\columnwidth]{figs/reinit_tls}
\caption{Lazy TLS reinitialization}
\label{fig:reinit_tls}
\end{figure}
