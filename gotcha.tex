...
1.17.0 of the Deno JavaScript runtime~\cite{www-javascript-deno}, which ships as a
single 81-MB executable that
includes the V8 engine~\cite{www-javascript-v8} and all its other dependencies except
for glibc and libgcc.
