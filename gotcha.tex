...
the corresponding pointer from the GOT.  Taking a pointer to a function works the
same way.
...
location.  As with GOT entries, there are PLT entries for functions defined both
within and outside the referencing module.
