...
\solb{Explicitly disambiguate the term ``asynchronous,'' which means ``background''
in the context of invocation, ``deferred'' in the context of I/O and futures, and
``preemptive'' in the context of signals and threads.  A chart showing where we fall
on the invocation and interruption axes will help with this.}
