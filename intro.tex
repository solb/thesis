...
\solb{Get the tail at scale/fan-out argument in here, following it with Anuj's ``we
want low latency'' -> ``modern datacenter networks make it possible'' flow.
Punctuate with his Azure latency citation.}
...
\solb{We used to cite Lampson here; let's do that again.}
