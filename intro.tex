...
library\ifdefined\dga
, typically consisting of a scheduler that distributes work to a pool of
OS-managed worker threads\xspace
\else
\xspace that maps user threads corresponding to futures onto kernel threads serving
as workers (i.e., an M:N thread pool)\xspace
\fi.  Without uncommon kernel
