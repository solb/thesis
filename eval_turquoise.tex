...
\Chap~\ref{sec:libturquoise} are transparent, making \textit{hyper} preemptive was
...
\begin{figure*}
	\begin{minipage}{0.5075\textwidth}
...
\thesis{Is it worth trying to get this running with HTTPS to increase dependence on
dynamic libraries?}
