...
\solb{Dave's introduction to precede this:  We found an optimization that does xyz.
A library used by the starting libset that is unable to call \texttt{launch()} can
never cause a switch out of the starting libset, and therefore we do not need to
intercept its function calls or global variable accesses.}
...
\input[functions]{eval_cancelled}
