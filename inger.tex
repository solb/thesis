...
\texttt{OneTimePadded} for storing data that could only be unwrapped once.  We can
imagine such a value from \texttt{closure}:
\begin{lstlisting}
...
\begin{lstlisting}[morekeywords={fn,impl}]
