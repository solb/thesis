...
At the start of this thesis, we set out to substantiate this thesis statement:
\begin{quote}
\input{statement}
\end{quote}
...
We introduced novel programming abstractions for isolation of both time and memory.
...
This summary makes specific references to key contributions; we now explain each and
give pointers back to the relevant chapters and sections.
