...
\dga{Start something like this instead: ``Unlike prior work, we run on top of the
existing OS.  An obvious design to achieve our goals would be to use a thread or
process, the existing concurrency mechanisms provided by the OS.}
