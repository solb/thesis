...
\mk{Sec 2 says 16 cores (15 workers)}
\mk{I'm a bit confused about the terminology of latency, runtime, and maybe invocation latency?}
\mk{Check these numbers with sec2}
...
\mk{do we need to remind reader about workers?}
...
\mk{this sounds cool, but slightly opaque.  What is context here?}
