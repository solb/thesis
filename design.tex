...
demonstrating how to convert an existing cooperative
...
completes on time, \texttt{launch()} returns its result to the caller; otherwise,
...
overloading, it is possible to achieve the other syntax by defining the
