...
dynamically-linked functions and global variables by one and two orders of magnitude,
respectively.  Fortunately, the names of the symbols we introduce are well known, so
when integrating the new runtime components, we could introduce exceptions to prevent
