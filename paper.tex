...
\newcommand{\CONFERENCE}{EuroSys 2020}
...
\usepackage{listings}
\lstdefinelanguage[C99]{C}[ANSI]{C}{morekeywords={bool,true,false,NULL},keywordsprefix=uint}
\lstset{captionpos=b,basicstyle=\ttfamily,language=[C99]C,showstringspaces=false,numbers=left,numbersep=4pt,tabsize=2,breaklines}
...
{\em * Carnegie Mellon University \; $^\dagger$ BrdgAI}}
