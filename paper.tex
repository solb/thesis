...
\newcommand{\libinger}{\texttt{libinger}}
...
\date{}
\title{\textbf{\TITLE}}
\author{{\large Sol Boucher*, Anuj Kalia$^\dagger$, David G.\@ Andersen*$^\ddagger$, and Michael Kaminsky$^\ddagger$*}\\
{\em * Carnegie Mellon University \; $^\dagger$ Microsoft Research \; $^\ddagger$ BrdgAI}\\
{\normalsize $^\dagger$ This author was at Carnegie Mellon when this research was completed.}}
